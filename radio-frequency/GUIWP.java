...
public class GUI extends JPanel {
    ...
    protected void paintComponent(Graphics gph){
        ...
        String T1 = "Information Panel";
        String T2 = "X Axis:";
        String T3 = "Y Axis:";
        String T4 = "Simulation type:";
        String T5 = "Current Formula:";
        String T6 = "Use case:";
        String T7 = "X Axis:";
        String T8 = "Y Axis:";
        String T9 = "Simulation type:";
        String T10 = "Current Formula:";
        String T11 = "Use case:";
        String T12 = "X Axis:";
        String T13 = "Y Axis:";
        String T14 = "Simulation type:";
        String T15 = "Current Formula:";
        String T16 = "Use case:";
        FontMetrics metrics = g2D.getFontMetrics();
        int labelWidthT1 = metrics.stringWidth(T1);
        g2D.setColor(Color.BLACK);
        g2D.drawString(T1, WIDTH-W_FRAME-L_PADDING, T_PADDING+H_FRAME+metrics.getHeight()+50);
        g2D.drawString(T2, WIDTH-W_FRAME-L_PADDING, T_PADDING+H_FRAME+metrics.getHeight()+75);//Point
        g2D.drawString(T3, WIDTH-W_FRAME-L_PADDING, T_PADDING+H_FRAME+metrics.getHeight()+100);//Point
        g2D.drawString(T4, WIDTH-W_FRAME-L_PADDING, T_PADDING+H_FRAME+metrics.getHeight()+125);//Point
        g2D.drawString(T5, WIDTH-W_FRAME-L_PADDING, T_PADDING+H_FRAME+metrics.getHeight()+150);//Point
        g2D.drawString(T6, WIDTH-W_FRAME-L_PADDING, T_PADDING+H_FRAME+metrics.getHeight()+175);//Point
        g2D.drawString(T7, WIDTH-W_FRAME-L_PADDING+400, T_PADDING+H_FRAME+metrics.getHeight()+75);//Point
        g2D.drawString(T8, WIDTH-W_FRAME-L_PADDING+400, T_PADDING+H_FRAME+metrics.getHeight()+100);//Point
        g2D.drawString(T9, WIDTH-W_FRAME-L_PADDING+400, T_PADDING+H_FRAME+metrics.getHeight()+125);//Point
        g2D.drawString(T10, WIDTH-W_FRAME-L_PADDING+400, T_PADDING+H_FRAME+metrics.getHeight()+150);//Point
        g2D.drawString(T11, WIDTH-W_FRAME-L_PADDING+400, T_PADDING+H_FRAME+metrics.getHeight()+175);//Point
        g2D.drawString(T12, WIDTH-W_FRAME-L_PADDING+800, T_PADDING+H_FRAME+metrics.getHeight()+75);//Point
        g2D.drawString(T3, WIDTH-W_FRAME-L_PADDING+800, T_PADDING+H_FRAME+metrics.getHeight()+100);//Point
        g2D.drawString(T14, WIDTH-W_FRAME-L_PADDING+800, T_PADDING+H_FRAME+metrics.getHeight()+125);//Point
        g2D.drawString(T15, WIDTH-W_FRAME-L_PADDING+800, T_PADDING+H_FRAME+metrics.getHeight()+150);//Point
        g2D.drawString(T16, WIDTH-W_FRAME-L_PADDING+800, T_PADDING+H_FRAME+metrics.getHeight()+175);//Point
    }//end simulateGraph
